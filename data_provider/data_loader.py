...
class UEAloader(Dataset):
    ...
    def __init__(self, root_path, file_list=None, limit_size=None, flag=None):
        ...
        # print("\nall_IDs长度：",len(self.all_IDs))

        # # 添加以下打印语句以输出数据尺寸
        # print("原始输入数据尺寸:")
        # print("- all_df (num_samples * seq_len, num_columns):", self.all_df.shape)
        # print("- feature_df (num_samples * seq_len, feat_dim):", self.feature_df.shape)
        # print("- feature_names (length):", len(self.feature_names))
